...
import 'package:fluffychat/pages/messie_auth/sign_in/view_model/messie_sign_in_view_model.dart';
...
class MessieSignInPage extends StatelessWidget {
  final bool signUp;
  const MessieSignInPage({required this.signUp, super.key});

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return ViewModelBuilder(
      create: () => MessieSignInViewModel(Matrix.of(context), signUp: signUp),
                ...
                if (state.publicHomeservers.connectionState ==
                  ...
                  Expanded(
                    child: Material(
                      ...
                      child: RadioGroup<MessiePublicHomeserverData>(
