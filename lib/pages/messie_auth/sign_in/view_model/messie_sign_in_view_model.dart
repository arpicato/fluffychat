...
import 'package:fluffychat/pages/messie_auth/sign_in/view_model/messie_sign_in_state.dart';
...
class MessieSignInViewModel extends ValueNotifier<MessieSignInState> {
  final MatrixState matrixService;
  final bool signUp;
  final TextEditingController filterTextController = TextEditingController();

  MessieSignInViewModel(this.matrixService, {required this.signUp})
    : super(MessieSignInState()) {
  ...
  void _filterHomeservers() {
    ...
    if (filterText.length >= 3 &&
      ...
      filteredPublicHomeservers.add(
        MessiePublicHomeserverData(name: filterText),
      );
    }
  ...
  Future<void> refreshPublicHomeservers() async {
    ...
    final defaultHomeserverData = MessiePublicHomeserverData(
    ...
    try {
      ...
      final publicHomeservers = homeserverJsonList
          .map((json) => MessiePublicHomeserverData.fromJson(json))
          .toList();
  ...
  void selectHomeserver(MessiePublicHomeserverData? publicHomeserverData) {
