class MessiePublicHomeserverData {
  final String? name;
  ...
  factory MessiePublicHomeserverData.fromJson(Map<String, dynamic> json) {
    return MessiePublicHomeserverData(
      name: json['name'],
