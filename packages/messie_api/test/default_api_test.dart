...
void main() {
  ...
  group(DefaultApi, () {
    ...
    // Submit a login step
    //
    //Future<BridgeLoginStep> bridgeSubmitLoginStep(String processId, String stepId, String action, String provider, { BuiltMap<String, JsonObject> requestBody }) async
