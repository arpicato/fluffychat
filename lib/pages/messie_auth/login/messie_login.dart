...
import 'messie_login_view.dart';

class MessieLogin extends StatefulWidget {
  final Client client;
  const MessieLogin({required this.client, super.key});

  @override
  MessieLoginController createState() => MessieLoginController();
}

class MessieLoginController extends State<MessieLogin> {
  ...
  @override
  Widget build(BuildContext context) => MessieLoginView(this);
}
